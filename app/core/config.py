...
class Settings(BaseSettings):
    ...
    CHAT_LLM_MAX_TOKENS: int | None = Field(default=None, ge=1)
    ...
    BEDROCK_RERANK_MODEL_ID: str = Field(default="cohere.rerank-v3-5:0", min_length=1)
    BEDROCK_RERANK_CANDIDATE_LIMIT: int = Field(default=20, ge=1)
    OPENAI_API_KEY: str | None = None
    OPENAI_API_BASE_URL: str = Field(default="https://api.openai.com/v1", min_length=1)
    OPENAI_RERANK_MODEL_ID: str = Field(default="gpt-4o-mini", min_length=1)
